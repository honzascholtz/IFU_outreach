...
class Viz_outreach:
    ...
    def __init__(self, ):
        ...
        gs = fig.add_gridspec(
            3, 3, height_ratios=(2,1,1), width_ratios=(1,1,1))
        
        self.ax0 = fig.add_subplot(gs[0,:])
        self.axres = fig.add_subplot(gs[1,:], sharex=self.ax0)
        ...
        # Redshift slider
        self.slider_z_ax = plt.axes([0.12, y0, 0.8, 0.03])
        ...
        # Mass Slider
        self.slider_mass_ax = plt.axes([0.12, y0-dy, 0.8, 0.03])
        ...
        # Log U slider
        self.slider_logU_ax = plt.axes([0.12, y0-2*dy, 0.8, 0.03])
        ...
        # Metal Slider
        self.slider_metal_ax = plt.axes([0.12, y0-3*dy, 0.8, 0.03])
        ...
        # Age Slider
        self.slider_age_ax = plt.axes([0.12, y0-4*dy, 0.8, 0.03])
        ...
        # Age Slider
        self.slider_tau_ax = plt.axes([0.12, y0-5*dy, 0.8, 0.03])
        ...
        # Dust Slider
        self.slider_dust_ax = plt.axes([0.12, y0-6*dy, 0.8, 0.03])
    ...
    def plot_general(self):
        ...
        if np.nansum(self.model.spectrum[:, 1]/1e-18) ==0:
            ...
            self.ax0.text(0.05, 0.9,'score: {:.2f}'.format(self.score),\
                        transform = self.ax0.transAxes)
